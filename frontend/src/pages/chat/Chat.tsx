...
import ABlogoBlue from "../../assets/ABlogoBlue.png";
                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>Eden is currently in closed beta, help us improve it evert week by asking about programs, platform assistance or anything else! </h2>
                            </Stack>
                        ) : (
