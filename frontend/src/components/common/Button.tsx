...
export const ShareButton: React.FC<ShareButtonProps> = ({onClick}) => {
    const shareButtonStyles: ICommandBarStyles & IButtonStyles = {
        root: {
          ...
          height: 32,
          borderRadius: 4,
          background: 'radial-gradient(109.81% 107.82% at 100.1% 90.19%, #125394 33.63%, #125394 70.31%, #95A5D9 100%)',
        //   position: 'absolute',
        //   right: 20,
          padding: '5px 12px',
          marginRight: '20px'
        ...
        rootHovered: {
          background: 'linear-gradient(135deg, #0F6CBD 0%, #95A5D9 51.04%, #125394 100%)',
        },
        label: {
          fontWeight: 600,
          fontSize: 14,
